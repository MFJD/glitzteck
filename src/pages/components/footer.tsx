                ...
                <div className="xl:grid xl:grid-cols-3 xl:gap-8">
                    ...
                    <div className="mt-16 grid grid-cols-3 gap-8 xl:col-span-2 xl:mt-0">
                        ...
                        <div className="mt-10 md:mt-0">
                            <h3 className="text-2xl font-semibold leading-6 primaryText">Legal</h3>
                            <ul role="list" className="mt-6 space-y-4">
                        ...
                        <div className="mt-10 md:mt-0">
                            <h3 className="text-2xl font-semibold leading-6 primaryText">Contacts</h3>
                            <ul role="list" className="mt-6 space-y-4">

                                <li className="flex">
                                    <i className="ri-map-pin-fill mr-1 text-red-600 text-xl"></i>
                                    <a href="" className="text-lg text-gray-600 hover:text-gray-900">
                                        1400 Laurel Ave W, Minneapolis, MN 55405, États-Unis
                                    </a>
                                </li>
                                <li className="flex">
